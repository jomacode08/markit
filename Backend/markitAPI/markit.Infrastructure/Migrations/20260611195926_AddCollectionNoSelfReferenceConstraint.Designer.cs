...
namespace markit.Infrastructure.Migrations
{
    ...
    [Migration("20260611195926_AddCollectionNoSelfReferenceConstraint")]
    partial class AddCollectionNoSelfReferenceConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("markit.Domain.Entities.Collection", b =>
                {
                    ...
                    b.ToTable("collections", null, t =>
                        {
                            t.HasCheckConstraint("ck_collections_no_self_reference", "parent_id <> id");
                        });
                });
