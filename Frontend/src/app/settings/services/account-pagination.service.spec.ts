  ...
  describe('loadPage', () => {
    ...
    it('should update accounts signal with data from response', (done) => {
      const mockAccounts: AccountSummary[] = [
        { id: '1', userName: 'user1', accessType: 'internal', createdDate: new Date(), isLocked: false, enabled: true } as AccountSummary,
        { id: '2', userName: 'user2', accessType: 'external', createdDate: new Date(), isLocked: false, enabled: true } as AccountSummary
      ];
    ...
    it('should handle multiple page requests sequentially', (done) => {
      ...
      const mockAccounts2: AccountSummary[] = [
        { id: '11', userName: 'user11', accessType: 'external', createdDate: new Date(), isLocked: false, enabled: true } as AccountSummary
      ];
